...
function refreshData() {
    ...
    contract.methods.getUserInfo(currentAddr).call().then(user => {
        ...
        if (if (parseInt(dailyCompoundBonus) < parseInt(compoundCount)) {) {
